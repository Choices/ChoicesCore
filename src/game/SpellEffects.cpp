...
pEffect SpellEffects[TOTAL_SPELL_EFFECTS]=
{
    ...
    &Spell::EffectRedirectThreat,                           //130 SPELL_EFFECT_REDIRECT_THREAT          Tricks of trade and Misdirect
...
void Spell::DoSummonGuardian(SpellEffectIndex eff_idx, uint32 forceFaction)
{
    ...
    for(int32 count = 0; count < amount; ++count)
    {
		...
		case 31216:
			{
				// Set bounding/combat radii to default
				...
				// Copy owners sheathstate, and UnitBytes2_flags
...
void Spell::EffectRedirectThreat(SpellEffectIndex eff_idx)
{
	if(unitTarget)
	{
		...
		// Tricks of trade 15% damage increase buff
